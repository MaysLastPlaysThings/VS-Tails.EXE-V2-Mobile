...
class ClientPrefs
{
	public static var segaSonic:Bool = false;
	...
	public static var areYouTeles = false;
	...
	{
		FlxG.save.data.watchedShittySegaIntroSonic = segaSonic;
		...
		FlxG.save.data.isTeles = areYouTeles;
	...
	{
		if (FlxG.save.data.watchedShittySegaIntroSonic != null)
		{
			segaSonic = FlxG.save.data.watchedShittySegaIntroSonic;
		}
		...
		if (FlxG.save.data.isTeles != null)
