...
class GalleryState extends MusicBeatState
{
	...
	public static var description:Array<String> = [
		"Early Tails and Knuckles sketches",
		"Twitter.",
		"why you gotta poop",
		"Ermmm actually",
		"secret???",
		...
		"oh no",
		"Brofrend",
		"Scrapped Pico reskin",
		"Daddy Dearest concept",
		"var awesomesolodude:FlxSprite;",
		"Soic promo art",
		"Gameplay concept",
		"Eggman sketch",
		"Scrapped Eggman design",
		"Game Over Screen",
		"Scrapped Tails for OG Nightmare concept",
		"Scrapped Sonic VS Fang",
		"Scrapped Collision Chaos BG",
		"Teaser art",
		"OST art",
		"Promo art",
		"Final Escape",
		"Old Hall BG",
		"Upcoming remade Origin Eggman",
		"Old GG Sonic",
		"Scrapped character, might be reused",
		"Scrapped character (pixel art)",
		"Early gameplay",
		"Old SBZ BG",
		"Early Sidekick",
		"What the",
		...
		"Early Soic gameplay",
		"Pre-Reboot gameplay",
		"Very early Pre-Reboot Tails.EXE",
		"Early Pre-Reboot Tails.EXE and Tails",
		"Early Pre-Reboot Tails (recolored)",
		"Very early Pre-Reboot Tails",
		"Early Pre-Reboot Knuckles",
		"Early Pre-Reboot Eggman",
		"Early Pre-Reboot Boyfriend",
		"Early Pre-Reboot Girlfriend",
		"Early Pre-Reboot icons",
		"EXE BF",
		"EXE BF's icons",
		"Early Pre-Reboot Freeplay",
		"Chasinglovania",
		"Early Pre-Reboot promo art",
		"Earliest gameplay footage (pre v1)"
	];
	public static var peopleMade:Array<String> = [
		"FenixTheCat",
		"FenixTheCat",
		"MA",
		"FenixTheCat",
